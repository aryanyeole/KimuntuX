...
class BlockchainSettings(BaseSettings):
    ...
    sepolia_rpc_url: Optional[str] = Field(
        None,
        description="Primary Sepolia RPC endpoint (Alchemy or Infura URL).",
    )
    ...
    # ── Platform Wallet ──────────────────────────────────────────────────────
    platform_private_key: Optional[str] = Field(
        None,
    ...
    # ── Contract Addresses ───────────────────────────────────────────────────
    commission_contract_address: Optional[str] = Field(
        None,
        description="Deployed KimuntuXCommissionSystem contract address.",
    )
    wallet_contract_address: Optional[str] = Field(
        None,
    ...
    @classmethod
    def _validate_private_key(cls, v: str | None) -> str | None:
        if v is None:
            return None
