...
class CampaignAnalysisService:
    ...
    def _build_prompt(campaign: dict) -> str:
        ...
        prompt = (
            ...
            "Industry benchmarks for affiliate marketing:\n"
            "- Good CTR: >1%\n"
            "- Good ROAS: >3x\n"
            "- Good CVR: >2%\n\n"
            ...
            "Provide specific recommendations based on the actual numbers above. Reference specific metrics in your recommendations. Health score should reflect overall campaign performance against benchmarks.\n\n"
